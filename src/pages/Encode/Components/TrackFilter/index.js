  ...
  return (
    <Grid style={{ padding: "30px" }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6}>
          <StyledTextField
            ...
            onChange={(e) =>
              dispatch({
                type: actionTypes.SET_ENCODE_TRACKS_FILTER,
                data: { ...encode?.tracks?.trackFilters, id: e.target.value },
              })
            }
          />
          ...
          <Grid style={{ marginTop: 35 }}>
            <AppAutoComplete
              ...
              getSelectedValue={(e, v) =>
                dispatch({
                  type: actionTypes.SET_ENCODE_TRACKS_FILTER,
                  data: { ...encode?.tracks?.trackFilters, label: v?.name },
                })
              }
              placeholder={"Label"}
            />
      ...
      <Grid className="mt-5" container justifyContent="flex-end">
        ...
        <AppButton variant={"fill"} onClick={handleFilter}>
          Apply
        </AppButton>
      </Grid>
    </Grid>
