...
class Communication {
  fetchMySonicKey(limit, index, value) {
    ...
    return AppWebRequest(
      `/sonic-keys/owners/${getUserId()}?limit=${limit}&sort=-createdAt&skip=${index}`,
      "get",
      axiosConfig
    );
  }
  ...
  searchRadioStation(limit = 5, index = 0, value = "") {
    ...
    return AppWebRequest(
      `/radiomonitors/owners/${getUserId()}/subscribed-stations?skip=${index}&limit=${limit}`,
      "get",
      axiosConfig
    );
  }
  ...
  fetchRadioStationHits(radioId) {
    return AppWebRequest(
      `/detections/owners/${getUserId()}/STREAMREADER/count?radioStation=${radioId}`,
      "get"
    );
  }
  ...
  fetchThirdPartySonicKeys(channel, params) {
    return AppWebRequest(
      `/detections/owners/${getUserId()}/${channel}/data`,
      "get",
      { params: params }
    );
  }
  ...
  fetchThirdPartyDetectedDetails(sonicKey, channel, params) {
    return AppWebRequest(
      `/detections/owners/${getUserId()}/${channel}/sonicKeys/${sonicKey}/detected-details`,
      "get",
      { params: params }
    );
  }
  ...
  getCount(param) {
    return AppWebRequest(
      param !== undefined
        ...
        : `/radiomonitors/owners/${getUserId()}/subscriber-count`,
      "get"
    );
  }
  ...
  fetchSKForSpecificRadioStation(radio_id, _offset = 0, _limit = 10) {
    ...
    return AppWebRequest(
      `/detections/owners/${getUserId()}/STREAMREADER/data?radioStation=${radio_id}&skip=${_offset}&limit=${_limit}&sort=-createdAt`,
      "get"
    );
  }
  ...
  fetchRadioStationsAccToCountry(country, _offset = 0, _limit = 200) {
    log(country);
    return AppWebRequest(
      `/radiostations?country=${country}&skip=${_offset}&limit=${_limit}`,
      "get"
    );
  }
  ...
  onStartRadioStations(formData) {
    ...
    return AppWebRequest(
      `/radiomonitors/owners/${getUserId()}/start-listening-stream-bulk`,
      "put",
      axiosConfig
    );
  }
  ...
  onStopRadioStations(formData) {
    ...
    return AppWebRequest(
      `/radiomonitors/owners/${getUserId()}/stop-listening-stream-bulk`,
      "put",
      axiosConfig
    );
  }
  ...
  onDeleteRadioStations(formData) {
    ...
    return AppWebRequest(
      `/radiomonitors/owners/${getUserId()}/unsubscribe-bulk`,
      "delete",
      axiosConfig
    );
  }
  ...
  downloadFileWithS3Key(key) {
    ...
    return AppWebRequest(
      `/s3-file-uploads/signed-url/` + encodeURIComponent(key),
      "get",
      axiosConfig
    );
  }
  ...
  radioStationSubscribed(formData) {
    ...
    //return 0;
    return AppWebRequest(
      `/radiomonitors/owners/${getUserId()}/subscribe-bulk`,
      "post",
      axiosConfig
    );
  }
