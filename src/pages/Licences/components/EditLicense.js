...
export default function EditLicense() {
  ...
  const handleEditLicense = (e) => {
    ...
    updateLicenceKey(license?._id, payload)
      .then((res) => {
        setLicense(res);
  ...
  return (
    <MainContainer>
      <SubHeading>Edit license</SubHeading>
      <Content>Edit license</Content>
            ...
            <Grid container direction="column" className="mt-4">
                ...
                <DisabledTextField
                  ...
                  value={
                    (license?.type === "Company"
                      ...
                      : license?.users?.map((u) => u.username)) || ""
                  }
                />
              </Grid>
              ...
              <Grid item xs={12} md={8}>
                <StyledTextField
                  ...
                  type="number"
                  value={
                    license?.isUnlimitedEncode
                      ? Number.POSITIVE_INFINITY
                      : license?.maxEncodeUses
                  }
                  placeholder={
                    license?.isUnlimitedEncode ? "Unlimited" : "eg. 100"
                  }
                  onChange={(e) =>
              ...
              <Grid item xs={12} md={8}>
                <StyledTextField
                  ...
                  type="number"
                  value={
                    license?.isUnlimitedMonitor
                      ? Number.POSITIVE_INFINITY
                      : license?.maxMonitoringUses
                  }
                  placeholder={
                    license?.isUnlimitedMonitor ? "Unlimited" : "eg. 100"
                  }
                  onChange={(e) =>
                    setLicense({
                      ...license,
            ...
            <Grid container direction="column" className="mt-4">
              ...
              {license?.type === "Company" && (
                <Grid className="mt-2">
                  <AddNewUser
                    license={license}
                    setLicense={(data) => setLicense(data)}
                  />
                </Grid>
              )}
            </Grid>
