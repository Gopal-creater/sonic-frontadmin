...
export default function CreateUser() {
  ...
  const handleOnCreateUser = (data) => {
    ...
    let payload = {
      ...
      company:
        state.company?._id ||
        user?.userProfile?.data?.company?._id ||
        undefined,
                ...
                render={({
                  ...
                  <>
                    <FormControlLabel
                      ...
                      label={
                        <CheckBoxLabelContainer>
                          <Content>Mark email as verified*</Content>
                        </CheckBoxLabelContainer>
                      }
                    />
                    {error?.message && (
                ...
                render={({
                  ...
                  <>
                    <FormControlLabel
                      ...
                      label={
                        <CheckBoxLabelContainer>
                          <Content>Mark phone number as verified</Content>
                        </CheckBoxLabelContainer>
                      }
                    />
                    {error?.message && (
          ...
          <Grid item xs={12} md={6}>
            ...
            <Content className="mt-2">
              {user?.userProfile?.data?.userRole === userRoles.PARTNER_ADMIN
                ? state.accountType
                : "Company"}{" "}
              details {state.accountType === "Company" && "(optional)"}
            </Content>
            {user?.userProfile?.data?.userRole === userRoles.PARTNER_ADMIN ? (
              <>
                {state.accountType === "Partner" ? (
                  ...
                  <>
                    <CompanyPopper
                      title={"Add associated new company"}
                      showDetails={(flag) =>
                        setState({ ...state, showCompanyDetails: flag })
                      }
                    >
                      <AppAutoComplete
              ...
              <>
                ...
                <Grid style={{ marginTop: 15 }}>
                  <DisabledTextField
                    label={"Company URN/ID"}
                    value={
                      user?.userProfile?.data?.company?.companyUrnOrId || ""
                    }
                  />
                </Grid>
              </>
              ...
              render={({
                ...
                <>
                  <FormControlLabel
                    ...
                    label={
                      <CheckBoxLabelContainer>
                        <Content>Send email invitation to the new user</Content>
                      </CheckBoxLabelContainer>
                    }
                  />
