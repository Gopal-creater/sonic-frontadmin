...
export default function Plays() {
    ...
    React.useEffect(() => {
        dispatch(getPlaysListsAction(
            ...
            playsList?.data?.page,
            10,
            playsList?.filters?.sonickey,
            playsList?.filters?.country,
            playsList?.filters?.artist,
            playsList?.filters?.radioStation,
            playsList?.filters?.song,
            playsList?.filters?.encodedDate,
        ));
